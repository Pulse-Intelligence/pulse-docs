...
Start: What are you building?
  ...
  +-- "A chatbot"
  |     |
  |     +-- Simple Q&A, one model        --> CHAT
  |     +-- Multi-step with logic         --> ADVANCED CHAT
  |     +-- AI picks its own tools        --> AGENT CHAT
  |
  +-- "An automation"
  |     |
  |     +-- Processes documents           --> RAG PIPELINE
  |     +-- Anything else                 --> WORKFLOW
  |
  +-- "A one-shot generator"             --> COMPLETION
```
